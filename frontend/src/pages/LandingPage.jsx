    ...
    <div className="landing-page">
        ...
        <div className="container">
          <div className="hero-grid">
            <div className="hero-content">
              ...
              <p>
                RoomPilot automates 90% of your property management tasks. Collect rent, screen
                residents, and manage communications - all while you sleep.
              </p>
              ...
              <div className="hero-buttons">
                ...
                <a href="#automation" className="btn-outline">
                  See It In Action
                </a>
              </div>
              ...
              <div style={{ display: 'flex', gap: '40px' }}>
                <div>
                  <strong style={{ fontSize: '24px', color: '#667eea' }}>2%</strong>
                  <br />
                  <span style={{ color: '#999' }}>Platform Fee</span>
                </div>
                <div>
                  <strong style={{ fontSize: '24px', color: '#667eea' }}>24hr</strong>
                  <br />
                  <span style={{ color: '#999' }}>Payouts</span>
                </div>
                <div>
                  <strong style={{ fontSize: '24px', color: '#667eea' }}>100%</strong>
                  <br />
            ...
            <div className="automation-preview">
              ...
              <div className="automation-steps">
                <div className="step">
                  ...
                  <div className="step-content">Resident applies through your listing</div>
                  <span className="step-check">✓</span>
                </div>
                <div className="step">
                  <span className="step-number">2</span>
                  <div className="step-content">Background check runs automatically</div>
                  <span className="step-check">✓</span>
                </div>
                <div className="step">
                  <span className="step-number">3</span>
                  <div className="step-content">Weekly rent collected on autopilot</div>
                  <span className="step-check">✓</span>
                </div>
                <div className="step">
                  <span className="step-number">4</span>
                  <div className="step-content">Instant payout to your bank account</div>
                  <span className="step-check">✓</span>
                </div>
              </div>
            </div>
        ...
        <div className="container">
          ...
          <div className="automation-grid">
            <div className="automation-card">
              <h3>
                <span className="icon">💰</span> Smart Billing Engine
              </h3>
              <p>
                Our intelligent billing system handles everything from weekly collections to late
                fees, all customizable to your rules.
              </p>
            ...
            <div className="automation-card">
              <h3>
                <span className="icon">👤</span> Resident Screening AI
              </h3>
              <p>
                Advanced screening that runs automatically when someone applies, giving you instant
                recommendations.
              </p>
              <ul className="automation-benefits">
            ...
            <div className="automation-card">
              <h3>
                <span className="icon">💬</span> Communication Hub
              </h3>
              <p>Automated messages keep everyone informed without you lifting a finger.</p>
              <ul className="automation-benefits">
            ...
            <div className="automation-card">
              <h3>
                <span className="icon">📊</span> Smart Analytics
              </h3>
              <p>Real-time insights and reporting that help you optimize your business.</p>
              <ul className="automation-benefits">
      ...
      <section className="final-cta" id="cta">
        <div className="container">
          ...
          <form action="https://formspree.io/f/mldadzqy" method="POST" className="email-capture">
            <input
              type="email"
              name="email"
        ...
        <div className="container">
          <div className="footer-grid">
            <div className="footer-brand">
              <h3>RoomPilot</h3>
              <p>
                The future of room rental management. Automate everything, keep more profit,
