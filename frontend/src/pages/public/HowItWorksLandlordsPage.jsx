    ...
    <div className="bg-white">
      <section className="bg-gradient-to-br from-accent-bg to-white py-[100px] px-10 text-center md:py-15 md:px-5">
        <div className="max-w-[800px] mx-auto">
          <span className="inline-block py-2 px-4 bg-[rgba(37,99,235,0.1)] rounded-full text-sm font-semibold text-primary mb-5 uppercase tracking-wide">For Landlords</span>
          <h1 className="font-display text-[clamp(2.5rem,5vw,3.5rem)] text-midnight mb-4 leading-tight">Maximize Your Rental Income</h1>
      ...
      <section className="py-[100px] bg-white md:py-15 md:px-5">
        <div className="max-w-[1200px] mx-auto px-10 md:px-5">
          <h2 className="font-display text-[clamp(2rem,4vw,2.5rem)] text-midnight text-center mb-15">Why Landlords Choose RoomPilot</h2>
      ...
      <section className="py-[100px] bg-snow md:py-15 md:px-5">
        <div className="max-w-[1200px] mx-auto px-10 md:px-5">
          <h2 className="font-display text-[clamp(2rem,4vw,2.5rem)] text-midnight text-center mb-15">Compare the Savings</h2>
          <div className="grid grid-cols-2 gap-8 max-w-[800px] mx-auto md:grid-cols-1">
            <div className="bg-white rounded-lg p-8 shadow-md">
              <h3 className="font-display text-2xl text-midnight mb-6 text-center">Other Platforms</h3>
              <ul className="list-none">
                <li className="py-3 border-b border-cloud text-[15px] text-coral">8-12% platform fees</li>
                <li className="py-3 border-b border-cloud text-[15px] text-coral">30+ day payout delays</li>
                <li className="py-3 border-b border-cloud text-[15px] text-coral">Forced tenant placements</li>
            ...
            <div className="bg-white rounded-lg p-8 shadow-md border-2 border-primary">
              ...
              <ul className="list-none">
                <li className="py-3 border-b border-cloud text-[15px] text-accent">Just 2% per payment</li>
                <li className="py-3 border-b border-cloud text-[15px] text-accent">Daily/weekly payouts</li>
                <li className="py-3 border-b border-cloud text-[15px] text-accent">You approve all tenants</li>
