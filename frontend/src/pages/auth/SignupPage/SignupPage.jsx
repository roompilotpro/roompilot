  ...
  return (
    <div className="font-body bg-gradient-to-br from-snow to-cloud min-h-screen flex flex-col text-midnight">
      <header className="py-8 px-4 text-center">
        <Link
          to={ROUTES.HOME}
          className="font-display text-[2rem] font-bold text-primary no-underline"
        >
          RoomPilot
        </Link>
      </header>
      ...
      <main className="flex-1 flex flex-col items-center justify-center py-8 px-4 max-w-[1100px] mx-auto w-full">
        <div className="text-center mb-12">
          <h1 className="font-display text-[2.5rem] md:text-[2rem] font-bold text-midnight mb-4 leading-tight">
