        ...
        <div className="container">
            ...
            {isAuthError ? (
              <div className="auth-error-card">
                ...
                <p className="auth-help">
                  Please log in to test the message API, or configure your backend to allow public
                  access to the message endpoints.
                </p>
          ...
          <div className="test-card status-section">
            ...
            <div className="status-grid">
              ...
              <div className="status-item">
                <div
                  className={`status-indicator ${messages.length > 0 ? 'active' : 'inactive'}`}
                ></div>
                <span>Database</span>
              </div>
              <div className="status-item">
