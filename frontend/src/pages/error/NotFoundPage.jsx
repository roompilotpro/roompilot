    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-snow to-cloud">
      ...
      <main className="flex-1 flex items-center justify-center p-8">
        <div className="max-w-[600px] text-center">
          ...
          <div className="font-display text-[8rem] font-extrabold text-primary leading-none mb-4 [text-shadow:0_4px_6px_rgba(37,99,235,0.2)] md:text-[6rem] sm:text-[4rem]">404</div>
          <h1 className="font-display text-[2.5rem] font-bold text-midnight mb-4 md:text-[2rem] sm:text-2xl">Oops! Page not found</h1>
          ...
          <div className="bg-white rounded-lg p-8 shadow-md">
            ...
            <ul className="list-none flex flex-col gap-3">
              ...
              <li className="flex items-center gap-3">
                <span className="text-xl">&#128218;</span>
                <Link to={ROUTES.HELP} className="text-primary no-underline font-medium transition-colors hover:text-[#1e40af] hover:underline">Visit Help Center</Link>
              </li>
              <li className="flex items-center gap-3">
                <span className="text-xl">&#10067;</span>
                <Link to={ROUTES.FAQ} className="text-primary no-underline font-medium transition-colors hover:text-[#1e40af] hover:underline">Browse FAQ</Link>
              </li>
            </ul>
          </div>
        </div>
